...
insert into employees (id,first_name, last_name, department_id, password, email)
values
(0,'Admin', 'Admin', 0, 'admin', 'admin.admin@levi9.com');

insert into employees (first_name, last_name, department_id, password, email)
values
('John', 'Dow', 1, null, 'john.dow@it.levi9.com'),
('Mary', 'Smith', 2, null, 'marysmith@finance.levi9.com'),
('Ann', 'Flower', 3, null, 'ann.flower@hr.levi9.com'),
('Mike', 'Harder', 4, null, 'mike.harder@support.levi9.com'),
('Alex', 'Trainer', 3, null, 'alex.trainer@hr.levi9.com');
